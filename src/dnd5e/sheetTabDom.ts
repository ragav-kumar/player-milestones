...
export function injectMilestonesTab(root: ParentNode): boolean {
  const tabsNav = root.querySelector<HTMLElement>("nav.sheet-tabs.tabs, nav.sheet-tabs, .sheet-tabs.tabs");
  const sheetBody = root.querySelector<HTMLElement>(".sheet-body, section.sheet-body, .tab-body, .sheet-content");
